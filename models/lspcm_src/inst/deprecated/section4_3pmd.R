...
# open the pdf file
cairo_pdf("~/lspm/inst/figures/pmd4_3.pdf", width = 10, height = 4)
...
vioplot(cbind(node50results3d5_0_thin[[paste0("seed",(seed_number[1]))]]$deltas),
...
title(ylab=expression(paste("Shrinkage strength")), line=2.2, cex.lab=1.5)
title(main = ("(2-5% e.d.)"),  line = 0.5, cex.main = 1.3, font.main=1)
for(seed in seed_number) {
  vioplot(node50results3d5_0_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1,1.05), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node50results3d5_0_thin,function(x) apply(x$deltas,2,mean)))),2,mean),pch=20, cex=1.5, col="green")
...
vioplot(node50results3d5_1_thin[[paste0("seed",(seed_number[1]))]]$deltas,
        ylim=c(0,15), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
for(seed in seed_number) {
  vioplot(node50results3d5_1_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1,1.05), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node50results3d5_1_thin,function(x) apply(x$deltas,2,mean)))),2,mean),pch=20, cex=1.5, col="green")


# alpha = 5 ----------------------------------------------------------------


vioplot(node50results3d5_5_thin[[paste0("seed",(seed_number[1]))]]$deltas,
        ylim=c(0,15), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
for(seed in seed_number) {
  vioplot(node50results3d5_5_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1,1.05), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node50results3d5_5_thin,function(x) apply(x$deltas,2,mean)))),2,mean),pch=20, cex=1.5, col="green")


# alpha = 10 ----------------------------------------------------------------

vioplot(node50results3d5_10_thin[[paste0("seed",(seed_number[1]))]]$deltas,
        ylim=c(0,15), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
axis(1, at=1:8, las=1, labels=1:8, cex.axis=1.5)
for(seed in seed_number) {
  vioplot(node50results3d5_10_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1,1.05), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node50results3d5_10_thin,function(x) apply(x$deltas,2,mean)))),2,mean),pch=20, cex=1.5, col="green")

# alpha = 20 ----------------------------------------------------------------

vioplot(node50results3d5_20_thin[[paste0("seed",(seed_number[1]))]]$deltas,
        ylim=c(0,15), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
axis(1, at=1:8, las=1, labels=1:8, cex.axis=1.5)
for(seed in seed_number) {
  vioplot(node50results3d5_20_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1,1.05), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node50results3d5_20_thin,function(x) apply(x$deltas,2,mean)))),2,mean),pch=20, cex=1.5, col="green")

# alpha = 30 ----------------------------------------------------------------
par(mar = c(5.6, 0, 4.1, 0.25)) # right margin set as 0.1

vioplot(node50results3d5_30_thin[[paste0("seed",(seed_number[1]))]]$deltas,
        ylim=c(0,15), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
axis(1, at=1:8, las=1, labels=1:8, cex.axis=1.5)
for(seed in seed_number) {
  vioplot(node50results3d5_30_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1,1.05), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node50results3d5_30_thin,function(x) apply(x$deltas,2,mean)))),2,mean),pch=20, cex=1.5, col="green")
