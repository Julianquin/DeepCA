...
# open the pdf file
cairo_pdf("~/lspm/inst/figures/pmv4_2.pdf", width = 10, height = 4)
...
vioplot(cbind(1/node100results4d3_thin[[paste0("seed",(seed_number[1]))]]$omegas, rep(0,nrow(node100results4d3_thin[[paste0("seed",(seed))]]$omegas))),
...
for(seed in seed_number) {
  vioplot(1/node100results4d3_thin[[paste0("seed",(seed))]]$omegas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red=0, green = 0, blue = 0, alpha=0.1))
}
points(1/cumprod(c(0.5,1.1,1.05,1.15)), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node100results4d3_thin,function(x) apply(1/x$omegas,2,mean)))),2,mean),pch=20, cex=2, col="green")
...
vioplot(1/node100results4d4_thin[[paste0("seed",(seed_number[1]))]]$omegas,
        ylim=c(0,6), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red=0, green = 0, blue = 0, alpha=0.1),
...
for(seed in seed_number) {
  vioplot(1/node100results4d4_thin[[paste0("seed",(seed))]]$omegas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red=0, green = 0, blue = 0, alpha=0.1))
}
points(1/cumprod(c(0.5,1.1,1.05,1.15)), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node100results4d4_thin,function(x) apply(1/x$omegas,2,mean)))),2,mean),pch=20, cex=2, col="green")
...
vioplot(1/node100results4d8_thin[[paste0("seed",(seed_number[1]))]]$omegas,
        ylim=c(0,6), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red=0, green = 0, blue = 0, alpha=0.1),
...
for(seed in seed_number) {
  vioplot(1/node100results4d8_thin[[paste0("seed",(seed))]]$omegas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red=0, green = 0, blue = 0, alpha=0.1))
}
points(1/cumprod(c(0.5,1.1,1.05,1.15)), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node100results4d8_thin,function(x) apply(1/x$omegas,2,mean)))),2,mean),pch=20, cex=2, col="green")
