...
# open the pdf file
cairo_pdf("~/lspm/inst/figures/pmv4_1c.pdf", width = 10, height = 4)
...
vioplot(cbind(1/node20results_c_thin[[paste0("seed",(seed_number[1]))]]$omegas),
...
for(seed in seed_number) {
  vioplot(1/node20results_c_thin[[paste0("seed",(seed))]]$omegas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(1/cumprod(c(0.5,1.1)), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node20results_c_thin,function(x) apply(1/x$omegas,2,mean)))),2,mean),pch=20, cex=2, col="green")
...
vioplot(1/node50results_c_thin[[paste0("seed",(seed_number[1]))]]$omegas,
        ylim=c(0,8), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
for(seed in seed_number) {
  vioplot(1/node50results_c_thin[[paste0("seed",(seed))]]$omegas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(1/cumprod(c(0.5,1.1)), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node50results_c_thin,function(x) apply(1/x$omegas,2,mean)))),2,mean),pch=20, cex=2, col="green")
...
vioplot(1/node100results_c_thin[[paste0("seed",(seed_number[1]))]]$omegas,
        ylim=c(0,8), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
for(seed in seed_number) {
  vioplot(1/node100results_c_thin[[paste0("seed",(seed))]]$omegas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(1/cumprod(c(0.5,1.1)), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node100results_c_thin,function(x) apply(1/x$omegas,2,mean)))),2,mean),pch=20, cex=2, col="green")


# 200 nodes ---------------------------------------------------------------
par(mar = c(5.6, 0, 4.1, 0.25)) # right margin set as 0.1

vioplot(1/node200results_c_thin[[paste0("seed",(seed_number[1]))]]$omegas,
        ylim=c(0,8), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
axis(1, at=1:8, las=1, labels=1:8, cex.axis=1.5)
for(seed in seed_number) {
  vioplot(1/node200results_c_thin[[paste0("seed",(seed))]]$omegas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(1/cumprod(c(0.5,1.1)), col='red', pch=4, cex=2, lwd=4) # true
points(apply(t(as.data.frame(lapply(node200results_c_thin,function(x) apply(1/x$omegas,2,mean)))),2,mean),pch=20, cex=2, col="green")
