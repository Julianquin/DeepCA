...
# open the pdf file
pdf("~/lspm/inst/figures/pmd4_1.pdf", width = 10, height = 4)
...
vioplot(cbind(node20results_thin[[paste0("seed",(seed_number[1]))]]$deltas),
...
title(ylab=expression(paste("Shrinkage strength")), line=2.2, cex.lab=1.75)
for(seed in seed_number) {
  vioplot(node20results_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1), col='red', pch=4, cex=2, lwd=4) # true
...
vioplot(node50results_thin[[paste0("seed",(seed_number[1]))]]$deltas,
        ylim=c(0,25), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
for(seed in seed_number) {
  vioplot(node50results_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1), col='red', pch=4, cex=2, lwd=4) # true
...
vioplot(node100results_thin[[paste0("seed",(seed_number[1]))]]$deltas,
        ylim=c(0,25), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
for(seed in seed_number) {
  vioplot(node100results_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1), col='red', pch=4, cex=2, lwd=4) # true
...
vioplot(node200results_thin[[paste0("seed",(seed_number[1]))]]$deltas,
        ylim=c(0,25), cex=0.2, rectCol = NA, lineCol = NA, cex.lab=1.5, cex.main=1.5, cex.axis=1.5,
        colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1),
...
axis(1, at=1:8, las=1, labels=1:8, cex.axis=1.5)
for(seed in seed_number) {
  vioplot(node200results_thin[[paste0("seed",(seed))]]$deltas, add=TRUE, cex=0.2, rectCol = NA, lineCol = NA,
          colMed = NA, border=NA, col=rgb(red = 0, green=0, blue=0,alpha=0.1))
}
points(c(0.5,1.1), col='red', pch=4, cex=2, lwd=4) # true
